...
| 2   | Bathroom Security       | https://adventofcode.com/2016/day/2          | Part 1: Follow keypad movement instructions to determine the bathroom code. | [BathroomSecurityAOC2016Day2.java](./day2/BathroomSecurityAOC2016Day2.java) |
| 3   | Squares With Three Sides | https://adventofcode.com/2016/day/3 | Part 1: Count the number of possible triangles from the given side lengths.<br>Part 2: Count the number of possible triangles when reading columns as triangles. | [SquaresWithThreeSidesAOC2016Day3.java](./day3/SquaresWithThreeSidesAOC2016Day3.java) |
...
| 9   | Explosives in Cyberspace | https://adventofcode.com/2016/day/9 | Part 1: Compute the decompressed length of the input using non-recursive markers. | [ExplosivesInCyberspaceAOC2016Day9.java](./day9/ExplosivesInCyberspaceAOC2016Day9.java) |
